...
import BlockAnchor from "../Blocks/Anchor"
...
import BlockPhotoGrid from "../Blocks/PhotoGrid"
...
export default ({ blocks, featuredImage }) => {
  const blockMap = {
    ...
    "block-lab/photo-grid": BlockPhotoGrid,
      ...
      <div>
        {blocks &&
          blocks.map((data, index) => {
            ...
            data.attributes.keyValue=`page-block-${index}`
            return (
